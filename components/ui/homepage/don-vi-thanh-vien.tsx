...
function DonViThanhVien() {
  return (
    <section className="from-[#fffbf2] to-[#d7a755] mb-16 relative">
      ...
      <div className="px-4 w-full lg:w-3/4 m-auto flex justify-center relative">
        <div className="px-8 lg:px-16 bg-gradient-to-br from-[#157e9e] to-[#1a4c65] rounded-2xl py-8 w-full flex flex-col items-center border-gradient-yellow">
          <h2 className="text-3xl lg:text-5xl font-[800] text-white mb-4 text-center">ĐỐI TÁC</h2>
          <div className="flex gap-4 justify-center w-full">
            <div className="flex-1 flex justify-center items-center">
              <Image src="/doi-tac-1.png" alt="doi-tac-1" width={300} height={591} className="lg:w-3/4 lg:h-3/4" />
            </div>
            <div className="flex-1 flex justify-center items-center">
              <Image src="/doi-tac-2.png" alt="doi-tac-2" width={300} height={591} className="lg:w-3/4 lg:h-3/4" />
            </div>
            <div className="flex-1 flex justify-center items-center">
              <Image src="/doi-tac-3.png" alt="doi-tac-3" width={300} height={591} className="lg:w-3/4 lg:h-3/4" />
            </div>
            <div className="flex-1 flex justify-center items-center">
              <Image src="/doi-tac-4.png" alt="doi-tac-4" width={300} height={591} className="lg:w-3/4 lg:h-3/4" />
            </div>
          </div>
        </div>
      </div>

  ...
  return (
    <section className="bg-[url('/backround-doi-tac.png')] bg-[length:100%_100%] py-8">
      ...
      <div className="px-4 w-full lg:w-3/4 m-auto flex justify-center">
        <div className="px-16 bg-blue-400 rounded-2xl py-8 w-full flex flex-col items-center">

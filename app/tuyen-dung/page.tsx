  ...
  return (
    <main>
      ...
      <section className="max-w-7xl m-auto px-4 mb-16">
        <h2 className="text-3xl md:text-5xl font-[800] text-[#0F3E5A] text-center max-lg:mb-4 mb-8">Giới thiệu về 5E REAL</h2>
      ...
      <section className="max-w-7xl m-auto px-4 mb-8">
        ...
        <p className="text-center text-[#19366A] text-[1.25rem]">Bạn gửi CV về địa chỉ email: <a className="text-[blue] hover:underline" href='mailto:tuyendung@5ereal.vn'>tuyendung@5ereal.vn</a></p>
